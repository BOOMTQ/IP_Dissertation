...
\begin{itemize}
  ...
  \item I spent approximately 90 hours building the system, during which I wrote 1,800 lines of Python source code. This mainly included five main scripts that carry out scam defence processes, as well as two programs that set different reply strategies and interact with the GPT language model.
